...
<div class="bg-dark p-2 m-2 text-right">
 ...
 <form  method="post" action="/registration2a">
    @csrf
...
<div class="row m-2">
    ...
    <div class="col col-10  p-2">
        <input class="  form-control ml-4 " type="text" name="nom_pere" id="nom_pere">
    </div>
...
<div class="row m-2">
    ...
    <div class="col col-10  p-2">
        <input class="  form-control ml-4 " type="text" name="telephone_pere" id="telephone_pere">
    </div>
